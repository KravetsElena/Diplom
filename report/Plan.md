...
3. Покупка с действующей картой и датой +5 лет к текущей в поле "Год" и остальными полями валидными.\
   ...
   * В поле "Год" ввести дату +5 лет к текущей, например 28
   * Нажать кнопку "Продолжить"
...
1. Покупка с помощью действующей карты с не полным заполнением поля "Номер карты" и всех остальных полей валидными данными. Например 13 цифр.\
...
3. Покупка с помощью действующей карты с заполнением только имени в поле "Владелец" и всех остальных полей валидными данными.\
   ...
   *Шаги:*
    * Заполнить валидными данными поля "Номер карты", "Месяц", "Год", "CVC/CVV"
    * В поле "Владелец" ввести имя на латинице до 60 символов без пробелов
    * Нажать кнопку "Продолжить"
...
3. Риск возникновения ошибок на стыке с внешними приложениями. Тестирование проводится с заглушкой вместо банковского сервиса.
