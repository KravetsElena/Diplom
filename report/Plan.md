...
Поле "Месяц" - числа от 01 до 12, записанные в формате двух цифр, для текущего года не ранее текущего месяца.\ 
Поле "Год" - числа от 23 до 28\
...
3. Покупка с помощью недействующей карты с заполнением все полей валидными данными.\
...
3. Покупка с помощью действующей карты с заполнением поля "Месяц" одной цифрой и всех остальных полей валидными данными. Например 2.\
   *Ожидаемый результат:* Появляется сообщение "Неверный формат".
...
4. Покупка с помощью действующей карты с полем "Год" до 23 и всех остальных полей валидными данными. Например 22.\
...
5. Покупка с помощью действующей карты с заполнением поля "Год" после 28 и всех остальных полей валидными данными. Например 29.\
...
6. Покупка с помощью действующей карты с не полным заполнением поля "CVC/CVV" и всех остальных полей валидными данными. Например 2 цифры.\
   *Ожидаемый результат:* Появляется сообщение "Неверный формат".
...
7. Покупка с помощью действующей карты с невалидным полем "Месяц" и остальных полей валидными данными.\
   *Ожидаемый результат:* Появляется сообщение "Неверно указан срок действия карты".
...
8. Покупка с помощью действующей карты с пустым полем "Номер карты" и остальных полей валидными данными.\
   *Ожидаемый результат:* Появляется сообщение "Неверный формат".
...
9. Покупка с помощью действующей карты с пустым полем "Месяй" и остальных полей валидными данными.\
   *Ожидаемый результат:* Появляется сообщение "Неверный формат".
...
10. Покупка с помощью действующей карты с пустым полем "Год" и остальных полей валидными данными.\
   *Ожидаемый результат:* Появляется сообщение "Неверный формат".
...
11. Покупка с помощью действующей карты с пустым полем "Владелец" и остальных полей валидными данными.\
   *Ожидаемый результат:* Появляется сообщение "Неверный формат".
...
12. Покупка с помощью действующей карты с пустым полем "CVC/CVV" и остальных полей валидными данными.\
   *Ожидаемый результат:* Появляется сообщение "Неверный формат".
...
13. Покупка с помощью недействующей карты с пустым полем "Номер карты" и остальных полей валидными данными.\
   *Ожидаемый результат:* Появляется сообщение "Неверный формат".
...
14. Покупка с помощью недействующей карты с пустым полем "Месяй" и остальных полей валидными данными.\
   *Ожидаемый результат:* Появляется сообщение "Неверный формат".
...
15. Покупка с помощью недействующей карты с пустым полем "Год" и остальных полей валидными данными.\
    *Ожидаемый результат:* Появляется сообщение "Неверный формат".
...
16. Покупка с помощью недействующей карты с пустым полем "Владелец" и остальных полей валидными данными.\
    *Ожидаемый результат:* Появляется сообщение "Неверный формат".
...
17. Покупка с помощью недействующей карты с пустым полем "CVC/CVV" и остальных полей валидными данными.\
    *Ожидаемый результат:* Появляется сообщение "Неверный формат".
